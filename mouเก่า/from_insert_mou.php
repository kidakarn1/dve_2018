...
$sql="select * from mou,school where mou.school_id = school.school_id";	
	?>
    <head>
        <meta charset="utf-8">
     ...
     <section class="wrapper">
        ...
        <form class="form-horizontal" method= "post" action="">
         ...
         <div class="table-responsive">
            ...
            <tr>
                <th>รหัสสถานศึกษา</th>
                <th> <input type="text" class="form-control" name="school_id"value="<?php echo $row["school_id"];?>"></th><th class="col-sm-2"></th>
            </tr>
            <tr>
                <th>ชื่อประกอบการ</th>
                <th> <input type="text"class="form-control"  name="business_id"value="<?php echo $row["school_name"];?>"></th><th class="col-sm-2"></th>
            </tr>
			<tr>
