    ...
    <head>
        ...
        <section id="main-content">
            <section class="wrapper">
                <div class="col-sm-12">
                <h3 class="page-header" style="color: red;"><i style="color: red;" class="fa fa-calendar"></i><b>แก้ไขข้อมูลสวัสดิการ</b></h3>
                </div>
...
$description=$_POST['description'];
    ...
    ?>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-3"><?php echo $row["detail_benefit_id"];?>
            </div>
            </div>
            <div class="form-group">
            <label class="col-xs-5 col-sm-2 control-label">รหัสการฝึกงาน</label>	
            <div class="col-sm-3">
            <input class="form-control" type="text" name="trainnig_id"value="<?php echo $row["trainnig_id"];?>"></div>
            </div>
            <div class="form-group">
            <label class="col-xs-5 col-sm-2 control-label">รายละเอียด</label>	
            <div class="col-sm-3"><input class="form-control" type="text" name="description"value="<?php echo $row["description"];?>"></th>
            </div>
                </div>
