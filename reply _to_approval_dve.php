...
$sql2 = "select * from business,training_dve,student where training_dve.citizen_id = student.citizen_id and  training_status = '{$tob}' and training_dve.business_id = business.business_id and (student.std_id like '%$serch%' or student.std_name like '%$serch%' or  business.business_name like '%$serch%' ) limit  $Page_Start , $Per_Page";
