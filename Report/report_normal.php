<?php  ini_set('max_execution_time', 300000); //300 seconds = 5 minutes ?>
<?php
...
<html lang="en">
 <head>
  ...
  include("function_date.php");
	...
	$sqlN = "select * from business,district,province,amphur,training_normal,department,student where business.district_id = district.DISTRICT_CODE 
 ...
 <td>
	...
	<br>
	รายงานขัอมูลการยื่นคำขอฝึกงาน ภาคเรียนที่<?php echo $rowY["term"]?> ปีการศึกษา  <?php echo $rowY["inter_year"];?><br>
