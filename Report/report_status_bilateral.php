...
<html lang="en">
 <head>
  ...
  include("function_date.php");
	...
	$sqlN = "select * from training_dve,business,student,department
	where training_dve.citizen_id = student.citizen_id 
 ...
 <td>
	...
	<br>
	รายงานผลการขออนุญาติฝึกอาชีพในสถาณประกอบการ <br>
	...
	<table border="1" align = "center" width="1500 %">
		...
		<?php 
			...
			<tr>
				...
				<td><?php echo $rowN["training_status"];?></td>
			</tr>
		<?php 
			} 
		?>
