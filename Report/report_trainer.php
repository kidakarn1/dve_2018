...
<html lang="en">
 <head>
  ...
  include("function_date.php");
	...
	$sqlN = "select *,COUNT(distinct trainer.trainer_id) as count from business,district,province,amphur,trainer
 ...
 <td>
	...
	<br>
	รายงานจำนวนครูฝึกในสถาณประกอบการ  ภาคเรียนที่ <?php echo $rowY["term"]?> ปีการศึกษา  <?php echo $rowY["inter_year"];?>
