...
<form class="form-horizontal" method="post" action="../MPDF/all_Student_apprentice_bilateral.php">
<body>
		<section id="main-content">
            <section class="wrapper">
                <div class="col-sm-12">
                    <h3 class="page-header" style="color: red;"><i style="color: red;" class="icon_zoom-in_alt"></i><b>สรุปรายชื่อนักศึกษาฝึกอาชีพ</b></h3>
                </div>
...
<?php function select_major($connect){
