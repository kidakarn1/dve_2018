    ...
    <nody>
        <section id="main-content">
            <section class="wrapper">
                <div class="col-sm-12">
                    <h3 class="page-header" style="color: red;"><i style="color: red;" class="icon_zoom-in_alt"></i><b>fromครูฝึก</b></h3>
                </div>

                <form  class="form-horizontal" method="post" action="../MPDF/report_trainer_end.php">
