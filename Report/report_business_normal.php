...
<html lang="en">
 <head>
  ...
  include("function_date.php");
	...
	$sqlN = "select *,COUNT(distinct training_normal.citizen_id) as count from business,district,province,amphur,training_normal where business.district_id = district.DISTRICT_CODE 
