...
$pdf->Ln(10);
			$pdf -> SetLeftMargin(20);
			$pdf ->Cell(295,7,iconv( 'UTF-8','TIS-620',$row_b['business_name']), 0 ,1,"C");

			$pdf->Cell(284, 7, iconv('UTF-8', 'TIS-620',$row_b['address_no']."  ".$row_b['road']."  ".$row_b['DISTRICT_NAME']), 0, 1, "C");
			$pdf->Cell(276, 7, iconv('UTF-8', 'TIS-620',$row_b['AMPHUR_NAME']."  ".$row_b['PROVINCE_NAME']."  ".$row_b['postcode']), 0, 1, "C");
            $pdf->Cell(262, 7, iconv('UTF-8', 'TIS-620', ''), 0, 1, "C");
			$pdf->Ln(2);
		   ...
		   $pdf->Ln(1);
		   $pdf->Cell(63, 7, iconv('UTF-8', 'TIS-620', 'เรียน ผู้อำนวยการวิทยาลัยเทคนิคชลบุรี'), 0, 1, "C");
			 $pdf->Ln(1);
