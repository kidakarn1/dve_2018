...
<html lang="en">
    <head>
		...
		@SESSION_START();
			...
			$sql_select="select * from student,major,training_normal,groups,teacher where student.citizen_id = '{$_SESSION["citizen_id"]}' and student.major_id = major.major_id and student.citizen_id = training_normal.citizen_id and student.group_id = groups.group_id and groups.teacher_id = teacher.teacher_id";
            //echo $sql_select;   
            }
            if ( $row_student["system_id"]==2){
            $sql_select="select * from student,major,training_dve,groups,teacher where student.citizen_id = '{$_SESSION["citizen_id"]}' and student.major_id = major.major_id and student.citizen_id = training_dve.citizen_id and student.group_id = groups.group_id and groups.teacher_id = teacher.teacher_id ";
            //  echo $sql_select;
           // exit;    
            }
   ...
   <!-- <p style="margin-left:70%">....................................................................</p>-->
    ...
    <p>นักศึกษาระดับ <?php if ($row_select['edu_id'] == 2) {echo "ปวช";
	$level1=$row_select['edu_id'];} ?>
	<?php if ($row_select['edu_id'] == 3) {echo "ปวส";
	$level1=$row_select['edu_id'];} ?>
	ปีที่ <?php if ($row_select['edu_id'] == 2){
					if ($level > 2){
						echo "3";
						}
			echo $level;
...
<tr>
    ...
    ลงชื่อ .....................................................<br>
    ( <?php echo $row_select["teacher_name"];?> )<br>
    .............../.............../...............
</center></td>
<td>
