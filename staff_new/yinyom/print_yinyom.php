...
$sql1="select * from student,district,amphur,province,training_plan where 
...
$date_start_new=$row1["start_date"];
$date_end_new=$row1["end_date"];
$sql2="select * from training_normal,business where training_normal.citizen_id='$citizen_id'
...
//
$year_start=substr($date_start_new,0,4);
$mouth_start=substr($date_start_new,5,2);
$day_start=substr($date_start_new,8,7);
$year_start=$year_start+543;
$year_end=substr($date_end_new,0,4);
$mouth_end=substr($date_end_new,5,2);
$day_end=substr($date_end_new,8,7);
