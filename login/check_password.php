        ...
        <body>
            ...
            <section id="main-content">
                <section class="wrapper">
                    <div class="col-lg-12">
                    <h3 class="page-header" style="color: red;"><i style="color: red;" class="fa fa-laptop"></i><b>ยืนยันรหัสผ่านใหม่</b></h3>
                </div>
                    <form class="form-horizontal" method="post" action="update_password.php">
                        <div class="form-group">
                            <label class="control-label col-sm-offset-3 col-sm-2">รหัสผ่านใหม่</label>
                            <div class="col-sm-3">
                    ...
                    header("location: from_check_pass.php");
                }
                ?>
