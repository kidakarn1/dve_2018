...
$res_normal = select_normal($connect);
?>
    ...
    <body>
        ...
        <section id="main-content">
            <section class="wrapper">
                <!--overview start-->
                <div class="col-lg-12">
                    <h3 class="page-header" style="color: red;"><i style="color: red;" class="icon_star-half_alt"></i><b>select_normal</b></h3>
                </div>
                    ...
                    <center>
                        <table class="table">
                            ...
                            while ($row_normal = mysqli_fetch_assoc($res_normal)) {
                                ...
                                <tr>
                                    <th><?php echo $i; ?></th>
                                    <th><?php echo $row_normal["head_name_std"] . " " . $row_normal["std_name"] ?></th>
                                    <th><?php echo $row_normal["phone"] ?></th>
                                    <th><?php echo $row_normal["dep_name"] ?></th>
                                    <th><?php echo $row_normal["business_name"] ?></th>
                                    <th><a href="menu_dve.php?id=<?php echo $row_normal["citizen_id"] ?>">จัดการ</a></th>
                                </tr>
...
function select_normal($connect) {
    $sql = "select * from training_normal,student,business,department where "
            ...
            . "student.dep_id = department.dep_id";
