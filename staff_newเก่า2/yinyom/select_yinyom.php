...
<table border="1">
    ...
    <tr>
    <th><?php echo $row_yinyom["normal_id"]?></th>
...
$sql="select * from normal,student,department,business where normal_status = 'อนุมัติสถานประกอบการ' and normal.citizen_id = student.citizen_id and student.dep_id = department.dep_id and normal.business_id = business.business_id";
