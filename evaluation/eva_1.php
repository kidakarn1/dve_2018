                ...
                <div class="col-sm-12">
                    ...
                    <form id="form-test" class="form-horizontal" method="post" action="insert_eva.php">
                        ...
                        <table border="1" class="table text-center">
                            ...
                            <tr>
                                <td id="nested">
                                    <table border="1" id="table2" width="100%" style="text-align: center;">
                                        <tr>
                                            <td>มากที่สุด</td>
                                            <td style="border-left: 1px solid black;">มาก</td>
                                            <td style="border-left: 1px solid black;">ปานกลาง</td>
                                            <td style="border-left: 1px solid black;">น้อย</td>
                                            <td style="border-left: 1px solid black;">น้อยที่สุด</td>
                                        </tr>
                                    </table>
                                </td>
                            </tr>
                                ...
                                <tr>
                                    ...
                                    <td id="nested">
                                        ...
                                        while ($rowRa = mysqli_fetch_array($resRa)) {
                                            ?>
                                            <table border="1" id="table2" width="100%" style="border-bottom: 1px solid black; text-align: center;">
                                                <tr>
                                                    <td><input type="radio" class="scroe<?php  echo $rowRa["Que_id"]; ?>" name="<?php echo $rowRa["Que_id"]; ?>" value="5"></td>
