                                    ...
                                    <td id="nested">
                                        ...
                                        while ($rowRa = mysqli_fetch_array($resRa)) {
                                            ...
                                            <table id="table2" width="100%" style="border-bottom: 1px solid black;">
                                                <tr>
                                                    <td><input type="radio" class="scroe<?php echo $rowRa["Que_id"]?>" id="3" name="<?php echo $rowRa["Que_id"]; ?>" value="3"></td>
                                                    <td><input type="radio" class="scroe<?php echo $rowRa["Que_id"]?>" id="2" name="<?php echo $rowRa["Que_id"]; ?>" value="2"></td>
                                                    <td><input type="radio" class="scroe<?php echo $rowRa["Que_id"]?>" id="1" name="<?php echo $rowRa["Que_id"]; ?>" value="1"></td>
                                                </tr>
                                            </table>
                                        <?php $k++;} ?>
                                    </td>
