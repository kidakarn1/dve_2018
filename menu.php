                            ...
                            <ul class="sub">
							 <li>
                                ...
                                <li>
									...
									<i class="fa fa-angle-right"></i>เพิ่มแผนการฝึก
                                    </a>
                                </li>
                                <li >
								...
								<li >
                                 ...
                                 <li >
									...
									<i class="fa fa-angle-right"></i>เพิ่มการออกนิเทศ
                                    </a>
                                </li>
								<li >
                                    <a class="red" href="plan_nites/table_teacher_nites.php">
									<i class="fa fa-angle-right"></i>ตารางนิเทศ
                                    </a>
                                </li>
<?php } ?>
...
<?php if ($_SESSION['status'] == "Staff" || $_SESSION['status'] == "Admin") { ?> 
								...
								<li>
                                    <a class="red" href="chang_trainer_training.php">
...
<?php if ($_SESSION['status'] == "Staff" || $_SESSION['status'] == "Admin") { ?>
                        <li  class="sub-menu ">
                            ...
                            <ul class="sub">
                                ...
                                <li  class="sub-menu">
                                    <a class="red" href="evaluation/eva_1.php">
									<i class="fa fa-angle-right"></i>ความพึงพอใจ</a>
                                </li>
