...
<html>
  ...
  <?php
	...
	$sqlN = "select * from teacher,nites_normal where nites_normal.teacher_id = teacher.teacher_id";
 ...
 <body>
	<section id="main-content">
            <section class="wrapper">
                <!--overview start-->
                <div class="col-lg-12">
                    <h3 class="page-header" style="color: red;"><i style="color: red;" class="icon_key_alt"></i><b>Report</b></h3>
                </div>
		...
		<?php 
			...
			<tr>
				...
				<td><a href="report_nites_normal.php?teacher_id=<?php echo $rowN["teacher_id"];?>">รายงาน</a></td>
			</tr>
		<?php 
			} 
		?>
