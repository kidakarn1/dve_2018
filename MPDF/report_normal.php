...
<html lang="en">
 <head>
  ...
  <?php
	...
	$sqlN = "select * from business,district,province,amphur,normal,department,student where business.district_id = district.DISTRICT_CODE 
 ...
 <tr>
 <td><center>
	รายงานขัอมูลการยื่นคำขอฝึกงาน ภาคเรียนที่<?php echo $rowNH["semester"]?> ปีการศึกษา  <?php echo date("Y")+543;?><br>
