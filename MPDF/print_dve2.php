    ...
    <head>
		...
		<?php
            ...
            if ( $row_student["system_id"]==1){
				$sql="select * from normal,business,district,amphur,province where normal.citizen_id ='{$_SESSION['citizen_id']}'and normal.business_id = business.business_id  and
            ...
            if ( $row_student["system_id"]==2){
				$sql="select * from training,business,district,amphur,province where training.citizen_id ='{$_SESSION['citizen_id']}'and training.business_id = business.business_id  and
				business.district_id = district.DISTRICT_CODE and
				district.AMPHUR_CODE = amphur.AMPHUR_CODE and 
				amphur.PROVINCE_CODE = province.PROVINCE_CODE
				";            }
