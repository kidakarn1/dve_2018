...
<html lang="en">
 <head>
  ...
  <?php
	...
	$sqlN = "select *,COUNT(distinct bilateral.std_id) as count from business,district,province,amphur,bilateral where business.district_id = district.DISTRICT_CODE 
	...
	group by bilateral.business_id";
 ...
 <tr>
 <td><center>รายงานข้อมูลสถานประกอบการที่ประจำ ภาคเรียนที่<?php echo $rowNH["semester"]?> ปีการศึกษา  <?php echo date("Y")+543;?></center></td>
 </tr>
