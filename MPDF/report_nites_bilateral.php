...
<html lang="en">
 <head>
  ...
  include('mpdf.php');
	...
	$sqlN = "select * from business,teacher,nites_bilateral,bilateral,department,district,province,amphur,student
	where nites_bilateral.teacher_id = teacher.teacher_id 
	and nites_bilateral.b_id = bilateral.b_id 
	and bilateral.business_id = business.business_id 
	...
	and province.PROVINCE_NAME = 'ชลบุรี'	and nites_bilateral.teacher_id = '$teacher_id'
	";
